...
namespace KutuphaneOtomasyonu
{
    public partial class ogrenci_islemleri : Form
    {
        ...
        private void ekle_b_Click(object sender, EventArgs e)
        {
            ...
            int sonuc = o_islm.ogr_ekle(isim_t.Text, numara_t.Text, bolum_t.Text,email_t.Text,adres_t.Text);
            MessageBox.Show("Aramıza bir kişi daha eklendi :D");
        }
        ...
        private void guncelle_b_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int sonuc = o_islm.ogr_guncelle(int.Parse(id_t.Text), isim_t.Text, numara_t.Text, bolum_t.Text,email_t.Text,adres_t.Text);
        ...
        private void ogrenci_listesi_d_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                email_t.Text = row.Cells[4].Value.ToString();
                adres_t.Text = row.Cells[5].Value.ToString();
        ...
        private void adres_t_click(object sender, EventArgs e)
        {
            adres_t.Text = "";
        }
