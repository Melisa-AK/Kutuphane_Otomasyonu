...
{
    public partial class iade_ve_emanet : Form
    {
        public iade_ve_emanet()
        {
            InitializeComponent();
        }
        ...
        iade_emanet_islemleri islem_yap = new iade_emanet_islemleri();
        void veri_cek()
        {
        ...
        iade_emanet_islemleri alim_iade_ekle = new iade_emanet_islemleri();
        ...
        private void iade_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int Sonuc = alim_iade_ekle.tablo_iade_duzenleme(int.Parse(iade_ktp_id_t.Text), int.Parse(iade_ogr_id_t.Text), "iade",iade_ktp_trh_t.Text);
