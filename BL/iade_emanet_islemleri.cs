...
namespace BL
{
    public class iade_emanet_islemleri
    {
        ...
        public int tablo_iade_duzenleme(int kitapid, int ogrenciid, string islemturu,string iadeedilentarih)
        {
            //almaverme tablosundaki verileri güncellemek için sorgumuzu gönderiyoruz.
            int Sonuc = dl1.EkleSilGuncelle("update almaverme set iadeedilentarih='"+ iadeedilentarih+"', islemturu ='" + islemturu + "' where ogrenciid=" + ogrenciid + " and kitapid = " + kitapid + "", System.Data.CommandType.Text);
